...
public class Graphes {
	...
	public static Hashtable<Integer, ArrayList<Integer>> graphe3Neighbour(int n) {
		Hashtable<Integer, ArrayList<Integer>> g = new Hashtable<Integer, ArrayList<Integer>>();
		for (int i = 0; i < n; i++) {
	...
	public static Hashtable<Integer, ArrayList<Integer>> graphe3NeighbourVariante(int n) {
		Hashtable<Integer, ArrayList<Integer>> g = graphe3Neighbour(n);
		for (int i = 0; i < n-1; i++) {
			g.put(n * i + 1, toTab(0, n * i + 1 + n, n * i + 1 + n + 1));
			g.put(n * (i + 1), toTab(0, n * (i + 1) + n, n * (i + 1) + n - 1));
		}
		return g;
	}
